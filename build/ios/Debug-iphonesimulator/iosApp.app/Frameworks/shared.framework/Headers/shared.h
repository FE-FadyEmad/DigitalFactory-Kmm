...
*/
- (void)getDataWithCompletionHandler:(void (^)(NSArray<SharedDomainModel *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getData(completionHandler:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DomainModel")))
@interface SharedDomainModel : SharedBase
...
- (SharedBoolean * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedDomainModel *)doCopyFlightNumber:(int32_t)flightNumber missionName:(NSString *)missionName launchDateUTC:(NSString *)launchDateUTC launchSuccess:(SharedBoolean * _Nullable)launchSuccess __attribute__((swift_name("doCopy(flightNumber:missionName:launchDateUTC:launchSuccess:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DataDomainMapper")))
@interface SharedDataDomainMapper : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSArray<SharedDomainModel *> *)mapDataToDomainData:(NSArray<SharedDataModel *> *)data __attribute__((swift_name("mapDataToDomain(data:)")));
@end

__attribute__((swift_name("DataSource")))
@protocol SharedDataSource
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getDataWithCompletionHandler:(void (^)(NSArray<SharedDataModel *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getData(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RemoteDataSource")))
@interface SharedRemoteDataSource : SharedBase <SharedDataSource>
- (instancetype)initWithServiceApi:(SharedServiceApi *)serviceApi __attribute__((swift_name("init(serviceApi:)"))) __attribute__((objc_designated_initializer));
...
@interface SharedRepositoryImpl : SharedBase <SharedRepository>
- (instancetype)initWithDataSource:(id<SharedDataSource>)dataSource mapper:(SharedDataDomainMapper *)mapper __attribute__((swift_name("init(dataSource:mapper:)"))) __attribute__((objc_designated_initializer));
...
- (instancetype)initWithNetworking:(id<SharedNetworking>)networking __attribute__((swift_name("init(networking:)"))) __attribute__((objc_designated_initializer));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DataModel")))
@interface SharedDataModel : SharedBase
- (instancetype)initWithFlightNumber:(int32_t)flightNumber missionName:(NSString *)missionName launchDateUTC:(NSString *)launchDateUTC launchSuccess:(SharedBoolean * _Nullable)launchSuccess __attribute__((swift_name("init(flightNumber:missionName:launchDateUTC:launchSuccess:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedDataModelCompanion *companion __attribute__((swift_name("companion")));
- (int32_t)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedBoolean * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedDataModel *)doCopyFlightNumber:(int32_t)flightNumber missionName:(NSString *)missionName launchDateUTC:(NSString *)launchDateUTC launchSuccess:(SharedBoolean * _Nullable)launchSuccess __attribute__((swift_name("doCopy(flightNumber:missionName:launchDateUTC:launchSuccess:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t flightNumber __attribute__((swift_name("flightNumber")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DataModel.Companion")))
@interface SharedDataModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedDataModelCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((swift_name("Networking")))
@protocol SharedNetworking
@required
@property (readonly) SharedKtor_client_coreHttpClient *httpClient __attribute__((swift_name("httpClient")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IOSNetworking")))
@interface SharedIOSNetworking : SharedBase <SharedNetworking>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (readonly) SharedKtor_client_coreHttpClient *httpClient __attribute__((swift_name("httpClient")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworkingKt")))
@interface SharedNetworkingKt : SharedBase
+ (id<SharedNetworking>)getNetworking __attribute__((swift_name("getNetworking()")));
@end
